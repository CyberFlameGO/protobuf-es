...
$(GEN)/protobuf-conformance: $(BIN)/protoc $(BUILD)/protoc-gen-es Makefile
	...
	@npx pbjs -t static-module -w es6 -o packages/protobuf-conformance/src/gen/protobufjs/protos_pb.js $(PB)/conformance/conformance.proto $(PB)/src/google/protobuf/any.proto $(PB)/src/google/protobuf/field_mask.proto $(PB)/src/google/protobuf/timestamp.proto $(PB)/src/google/protobuf/duration.proto $(PB)/src/google/protobuf/struct.proto $(PB)/src/google/protobuf/wrappers.proto $(PB)/src/google/protobuf/test_messages_proto3.proto $(PB)/src/google/protobuf/test_messages_proto2.proto
...
test-conformance-pbjs: $(BIN)/conformance_test_runner $(BUILD)/protobuf-conformance
	cd packages/protobuf-conformance \
		&& $(abspath $(BIN)/conformance_test_runner) --enforce_recommended --failure_list failing_tests_with_bigint_pbjs.txt    --text_format_failure_list failing_tests_text_format_pbjs.txt bin/conformance_esm_pbjs.js \
